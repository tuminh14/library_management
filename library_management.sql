...
(
    ...
    INDEX (people_id),
    INDEX (type_id),
    INDEX (reader_card_id),
    PRIMARY KEY (`id`),
	FOREIGN KEY (people_id)
        REFERENCES people(id)
        ON UPDATE CASCADE ON DELETE RESTRICT,
	FOREIGN KEY (reader_card_id)
		REFERENCES reader_card(id)
        ON UPDATE CASCADE ON DELETE RESTRICT,
	FOREIGN KEY (type_id)
...
(
    ...
    `book_borrowed_id` int(11),
    PRIMARY KEY (`id`),
	FOREIGN KEY (book_borrowed_id)
		REFERENCES book_borrowed(id)
);
...
CREATE TABLE IF NOT EXISTS lost_book_tracking (
	`id` int(11) NOT NULL AUTO_INCREMENT,
	`book_id` int(11) NOT NULL,
	`reader_id` int(11) NOT NULL,
	`staff_id` int(11) NOT NULL,
...
INSERT INTO `book` (`id`, `book_title`, `category_id`, `author`, `book_copies`, `book_pub`, `publisher_name`, `isbn`, `copyright_year`, `date_receive`, `date_added`, `status`) VALUES
